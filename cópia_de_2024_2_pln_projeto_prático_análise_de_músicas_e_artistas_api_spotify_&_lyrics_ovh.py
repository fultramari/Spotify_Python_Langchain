# -*- coding: utf-8 -*-
"""Cópia de 2024.2 - PLN Projeto Prático - Análise de Músicas e Artistas - API Spotify & Lyrics.ovh.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1c4snAkh3JG3dPUjZKuhgqw6CkdNenpLe
...
**POR FAVOR, PREENCHER OS INTEGRANTES DA SUA EQUIPE:**
...
**Integrante 02:**
Felipe Ultramari Domingues - 11202230317

**Integrante 03:**
Franco Armando Ayala Ccollcca - 11202230759
...
**LLM**: GPT-4o (Generative Pre-trained Transformer) da OpenAI
...
***Para o presente projeto, utilizamos duas APIs e o Streamlit, para exibição dos dados para o usuário de forma mais prática e convidativa.***
...
O projeto em questão é uma aplicação que integra a **API do Spotify**, do **Lyrics.ovh** e **Streamlit** com técnicas de **Processamento de Linguagem Natural** (PLN) para realizar **análises** e **gerar conteúdo** relacionado a um artista musical. A aplicação busca **informações detalhadas sobre o artista**, seus álbuns, músicas mais famosas, e letras de canções, utilizando essas informações para criar análises e resumos textuais através de modelos de linguagem.
